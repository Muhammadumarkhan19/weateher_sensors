...
if not file_exists:
    ...
    file.write('Time and Date,  pressure (hPa)\n')
# loop forever
while running:
    try:
        ...
        lcd_instance.lcd_display_string("Pressure={:.2f}hPa".format(pressure), 1) 

        # lcd_instance.lcd_display_string("Humidity={:0.1f}%".format(humidity), 2)
